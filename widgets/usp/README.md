...
cd widgets/usp
npm install
NODE_TLS_REJECT_UNAUTHORIZED=0 npx tsx --tsconfig "widgets/usp/tsconfig.app.json"  packages/widget-build/ssr-generation/render-page.ts usp ./widgets/usp/public/default.json
```
